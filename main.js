window.onload = function(){
	...
	window.setInterval(function () {
		document.getElementById('buttonAdd').onclick = function(){
			...
			body.innerHTML += "<div id=\"background\"></div><div id=\"addWindow\" class=\"window\"><h2>Verjaardag toevoegen</h2><input id=\"name\" name=\"name\" type=\"text\"><select id=\"day\" name=\"day\">" + daysHTML + "</select><select id=\"month\" name=\"month\">" + monthsHTML + "</select><input id=\"year\" name=\"year\" type=\"number\"><div><span id=\"buttonAddFinal\">Toevoegen</span> <span id=\"buttonCancel\">Annuleer</span></div></div>";
